    ...
    if sens_type == 'ox_rate':
        ...
        for ox_rate in ox_rates:
            ...
            if min_dep_threshold == True:
                ...
                output_path = base_path + f'/raster_sens_analysis/burial_lca_min{min_dep_str}_md{md_str}_exc{exc_str}_doz{doz_str}_ox{ox_str}_docf{docf_str}_ch4ox{ch4_str}.tif'
            else:
                output_path = base_path + f'/raster_sens_analysis/burial_lca_md{md_str}_exc{exc_str}_doz{doz_str}_ox{ox_str}_docf{docf_str}_ch4ox{ch4_str}.tif'
