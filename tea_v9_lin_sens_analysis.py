...
xi_beccs_h = 304.314 # Roads to Removal analysis gasification high bound + hydrogen incentive, convers. to 2026$
...
plt.savefig(save_path+'/tea_v9_lin_sens_analysis_oneway.png', dpi=300)
plt.show()

df.to_excel(save_path+"/tea_v9_lin_sens_analysis_oneway.xlsx", index=False)
...
#plt.gca().add_artist(legend2)
plt.savefig(save_path+'/tea_v9_lin_sens_analysis_4_pan_oneway.png', dpi=300)
plt.savefig(save_path+'/tea_v9_lin_sens_analysis_4_pan_oneway.svg')
plt.show()
...
plt.savefig(save_path+'/tea_v9_lin_sens_analysis_4_pan_char_sub_oneway.png', dpi=300)
plt.savefig(save_path+'/tea_v9_lin_sens_analysis_4_pan_char_sub_oneway.svg')
plt.show()
...
plt.savefig(save_path+'/tea_v9_lin_sens_analysis_4_pan_bur_sub_oneway.png', dpi=300)
plt.savefig(save_path+'/tea_v9_lin_sens_analysis_4_pan_bur_sub_oneway.svg')
plt.show()
